...
const Login = () => {
    ...
    return (
        <div className="md:h-[calc(100vh-120px)] flex flex-col justify-center">
            ...
            <div className="mx-5 md:w-1/2 my-10 my:mt-0 lg:w-[27%] px-6 pt-8 lg:pt-10 pb-10 lg:pb-12 md:mx-auto g-gray-50 bg-[rgba(243,244,246,.35)] shadow border">
                <h4 className="text-xl lg:text-2xl font-semibold text-[#7F8C8D] mb-6 lg:mb-8 uppercase">Login</h4>
                ...
                <div>
                    ...
                    <p className="text-[#7F8C8D]">Don't have an account? <Link to='/register' className="underline text-[#A88E64] font-medium">Register</Link></p>
                </div>
            </div>
        </div>
    );
