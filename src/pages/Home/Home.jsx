        ...
        <div className="mx-5 md:mx-0">
            ...
            <div className="lg:my-10">
                <div className="mt-4 md:mt-8 lg:mt-14 mb-6 lg:mb-10">
                    <h4 className="text-xl md:text-2xl lg:text-4xl font-bold text-center text-[#A88E64]">Top Tourist Spots Await You on TravelWise</h4>
                    <p className="lg:w-3/4 text-center mx-auto mt-3 text-xs md:text-base text-[#7F8C8D]">Embark on an unforgettable journey through Europe's cultural gems! Explore enchanting landmarks, vibrant cities, and breathtaking landscapes across France, Italy, Spain, England, Netherlands, and Switzerland with TravelWise's curated tourist spots section</p>
                </div>
                <div className="md:bg-[#EDF2F6] ">
