...
const Navbar = () => {
    ...
    return (
        <div className="navbar bg-base-100 border-b border-[#A88E64] pb-2 ">
            ...
            <div className="w-[48.8%] justify-end">
                <label className="flex cursor-pointer gap-2 mr-2">
                    <svg className='hidden md:grid' xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="5" /><path d="M12 1v2M12 21v2M4.2 4.2l1.4 1.4M18.4 18.4l1.4 1.4M1 12h2M21 12h2M4.2 19.8l1.4-1.4M18.4 5.6l1.4-1.4" /></svg>
                    <input onChange={handleTheme} type="checkbox" className="toggle theme-controller" />
                    <svg className='hidden md:grid' xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>
                </label>
                {
                    user ?
                        <div className='z-10'>
                            <div className='w-12 h-12 rounded-full tooltip  tooltip-bottom image-container' data-tooltip-id="my-tooltip" data-tooltip-content={user?.displayName || 'Unknown'} data-tooltip-place="bottom" >
                        ...
                        : <div className='flex gap-2 md:gap-4'>
                            <NavLink to='/login' className={({ isActive }) => isActive ? 'border-b-2 py-1.5 px-2 rounded-md border-[#A88E64] text-[#A88E64] text-lg font-medium' : 'text-[#7F8C8D] border px-1.5 text-sm md:text-base md:px-5 py-1.5 rounded-md border-[#A88E64] '}>Login</NavLink>
                            <NavLink to='/register' className={({ isActive }) => isActive ? 'border-b-2 py-1.5 px-2 rounded-md border-[#A88E64] text-[#A88E64] text-lg font-medium' : 'text-[#7F8C8D] border py-1.5 px-1.5 text-sm md:text-base md:px-3 rounded-md border-[#A88E64] '}>Register</NavLink>
                        </div>
                }
